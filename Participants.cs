...
namespace Challonge_API {
    public class Participants {
        ...
        static public async Task<JObject> Create(Api api, string tournament, Dictionary<string, string> parameters) {
            string path = "tournaments" + tournament + "/participants.json";

            return await api.FetchAndParse(Api.Methods.POST, path, parameters);
        }

        static public async Task<JObject> BulkAdd(Api api, string tournament, Dictionary<string, string> parameters) {
        ...
        static public async Task<JObject> Update(Api api, string tournament, string participantId, Dictionary<string, string> parameters) {
        ...
        static public async Task<JObject> CheckIn(Api api, string tournament, string participantId, Dictionary<string, string> parameters) {
            string path = "tournaments" + tournament + "/participants/" + participantId + "/check_in.json";

            return await api.FetchAndParse(Api.Methods.POST, path, parameters);
        }

        static public async Task<JObject> UndoCheckIn(Api api, string tournament, string participantId, Dictionary<string, string> parameters) {
            string path = "tournaments" + tournament + "/participants/" + participantId + "/undo_check_in.json";

            return await api.FetchAndParse(Api.Methods.POST, path, parameters);
        }

        static public async Task<JObject> Destroy(Api api, string tournament, string participantId, Dictionary<string, string> parameters) {
            string path = "tournaments" + tournament + "/participants/" + participantId + ".json";

            return await api.FetchAndParse(Api.Methods.DELETE, path, parameters);
        }

        static public async Task<JObject> ClearAll(Api api, string tournament, Dictionary<string, string> parameters) {
            string path = "tournaments" + tournament + "/participants/clear.json";

            return await api.FetchAndParse(Api.Methods.DELETE, path, parameters);
        }

        static public async Task<JObject> Randomize(Api api, string tournament, Dictionary<string, string> parameters) {
